export default function About() {
  return (
    <div className="min-h-screen bg-[#879983] py-8 md:py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl md:text-6xl text-white mb-6 md:mb-10 text-center font-['Dancing_Script'] drop-shadow-lg">
          About the Studio
        </h1>
        
        <div className="text-base md:text-lg text-[#ffffff] leading-relaxed space-y-6 md:space-y-8 font-['DM_Sans']">
          ...
          <p className="text-center md:text-left">
            It's about authentic connection, self-expression, and grounding in the present.
          </p>
          <p className="font-['Dancing_Script'] text-xl md:text-2xl text-[#ffffff] text-center md:text-left mt-8">
