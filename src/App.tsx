        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex gap-8 items-start">
            <div className="flex-1 space-y-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#879983] mb-2">Message your interest</h3>
                <p className="text-gray-600">Let me know you are keen, and I will send through some potentially available time slots.</p>
              </div>
              
              <div>
                <h3 className="text-2xl font-bold text-[#879983] mb-2">Choose a time, date and location</h3>
              ...
              <div>
                <h3 className="text-2xl font-bold text-[#879983] mb-2">Come and paint!</h3>
