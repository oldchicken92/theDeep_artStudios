      ...
      <section className="py-12 md:py-20 bg-[#AF957C]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <img src="/theDeep_artStudios/4c070121-e612-4394-8933-51ae1a062ee4.jpg" alt="Wave painting" className="w-full rounded-lg hover:opacity-90 transition-opacity shadow-lg" />
          </div>
        </div>
      </section>
