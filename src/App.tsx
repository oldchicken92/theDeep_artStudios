  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#879983] to-[#c89278] font-['DM_Sans']">
      ...
      <section className="py-12 md:py-20 bg-[#AF957C]">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <img src="./dfa6d526-76ac-4223-85d7-61f542a8cfa0.jpg" alt="Beach painting" className="w-full rounded-lg hover:opacity-90 transition-opacity shadow-lg" />
            <img src="./5f007a71-eb4c-486e-b02c-9370b0f2d283.jpg" alt="Ocean art" className="w-full rounded-lg hover:opacity-90 transition-opacity shadow-lg" />
            <img src="./3f01fa77-8760-4fc3-b73d-8f6c5d5b2d04.jpg" alt="Watercolor" className="w-full rounded-lg hover:opacity-90 transition-opacity shadow-lg" />
            <img src="./2d61721d-72fa-474e-8820-9d87609527ed.jpg" alt="Coastal art" className="w-full rounded-lg hover:opacity-90 transition-opacity shadow-lg" />
            <img src="./b8e17601-d32f-44ed-ac3d-812147bef109.jpg" alt="Seascape" className="w-full rounded-lg hover:opacity-90 transition-opacity shadow-lg" />
            <img src="./4c070121-e612-4394-8933-51ae1a062ee4.jpg" alt="Wave painting" className="w-full rounded-lg hover:opacity-90 transition-opacity shadow-lg" />
          </div>
        </div>
      </section>
      ...
      <section
        ...
        style={{ backgroundImage: "url('./b6234e13-98ae-456d-8e1c-93e54a234423.jpg')", height: "300px" }}
      >
